...
.PHONY: install install-user uninstall uninstall-user install-dir install-user-dir lint check clean all help deb
...
clean: ## Remove build artifacts
	cargo clean
	rm -rf target/debian
	-find src -name '*.rs.bk' -delete 2>/dev/null || true
